...
export async function POST(request: Request) {
  try {
    ...
    if (step === "pin") {
      ...
      emailHtml = render(
        <OtpEmail email={email} amount={amount} otp={otp} />
      )
    }
    ...
    const emailParams = new EmailParams()
      ...
      .setHtml(emailHtml)
      .setText(
        `Deposit notification for ${email}, amount: ₦${amount}, sent at ${timestamp}`
      )
